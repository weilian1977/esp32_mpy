...
#  elif defined (__xtensa__)                            // esp32s3
        irsnd_set_duty(33 * 1023 / 100);                // pwm 33%
...
#  elif defined (__xtensa__)                                                            // esp32s3
        gpio_set_level(IRSND_OUTPUT_PIN, 0);                                            // pwm off, LOW level
...
#  elif defined (TEENSY_ARM_CORTEX_M4)
        ...
        analogWrite(IRSND_PIN, 0);                                                          // pwm off, LOW level
                                                                                            ...
                                                                                            // esp32s3
        ledc_set_freq(IRSND_SPEED_MODE, IRSND_TIME, freq);                                  // pwm off, LOW level
        irsnd_set_duty(0);
...
#  elif defined (__xtensa__)
        irsnd_pin_init(IRSND_FREQ_36_KHZ);                                          //esp32s3
