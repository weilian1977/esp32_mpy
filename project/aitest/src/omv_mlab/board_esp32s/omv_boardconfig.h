...
// RAW buffer size
#define OMV_RAW_BUF_SIZE        (640*480*2)
...
#define JPEG_QUALITY_THRESH     (640*480*2)
...
#define OMV_JPEG_BUF_SIZE         (96 * 1024)   // IDE JPEG buffer (header + data).
