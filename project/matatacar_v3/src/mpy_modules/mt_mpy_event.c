...
static const mp_map_elem_t mt_mpy_event_locals_dict_table[] =
{
  ...
  { MP_OBJ_NEW_QSTR(MP_QSTR_EVENT_MICROPHONE_LESS),                  MP_OBJ_NEW_SMALL_INT(EVENT_MICROPHONE_LESS) },
  { MP_OBJ_NEW_QSTR(MP_QSTR_EVENT_MICROPHONE_MORE),                  MP_OBJ_NEW_SMALL_INT(EVENT_MICROPHONE_MORE) },
  { MP_OBJ_NEW_QSTR(MP_QSTR_EVENT_MESSAGE),                          MP_OBJ_NEW_SMALL_INT(EVENT_MESSAGE) },
