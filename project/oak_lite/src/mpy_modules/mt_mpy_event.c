...
static const mp_map_elem_t mt_mpy_event_locals_dict_table[] =
{
  ...
  { MP_OBJ_NEW_QSTR(MP_QSTR_EVENT_BUTTON_PRESSED),                   MP_OBJ_NEW_SMALL_INT(EVENT_BUTTON_PRESSED) },
  { MP_OBJ_NEW_QSTR(MP_QSTR_EVENT_BUTTON_RELEASED),                  MP_OBJ_NEW_SMALL_INT(EVENT_BUTTON_RELEASED) },
